    ...
    <div class="motorcade-main">
      ...
      <div class="tour-people" v-if="this.show">
        ...
        <div class="peo-message">
          <p v-for="item in this.travelers_list">
      ...
      <div class="trip-message">
        ...
        <div class="messages">
          <div class="message-car">
            <h4>出游费用</h4>
            <p class="car-type" v-for="item in travels">
                <span>{{ item.name }}</span>
      ...
      methods:{
          ...
          get_order_detail:function(){         //获取用户详情 请求
              ...
              get_order_detail(params).then((res) => {
                  this.order = res.data;
                  this.travels  = this.order.bill.travels;
                  this.additional = this.order.bill.additional;
          ...
          get_order_people:function(){           //获取订单出游人列表
              ...
              get_order_people(params).then((res) => {
                  this.travelers_list = res.data.travelers;
                  console.log(this.travelers_list)
                  if(this.travelers_list.length>0){
                    this.show = true;
                  }else{
                    this.show = false;
                  }
